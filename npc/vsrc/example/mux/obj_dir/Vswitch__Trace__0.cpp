...
void Vswitch___024root__trace_chg_0_sub_0(Vswitch___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vswitch___024root__trace_chg_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vswitch___024root__trace_chg_0\n"); );
    // Init
    ...
    // Body
    Vswitch___024root__trace_chg_0_sub_0((&vlSymsp->TOP), bufp);
}

void Vswitch___024root__trace_chg_0_sub_0(Vswitch___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    (void)vlSelf;  // Prevent unused variable warning
    Vswitch__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vswitch___024root__trace_chg_0_sub_0\n"); );
