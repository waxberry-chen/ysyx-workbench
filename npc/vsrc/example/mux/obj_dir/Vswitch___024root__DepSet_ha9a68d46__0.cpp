...
bool Vswitch___024root___eval_phase__ico(Vswitch___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vswitch__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vswitch___024root___eval_phase__ico\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Init
...
bool Vswitch___024root___eval_phase__act(Vswitch___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vswitch__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vswitch___024root___eval_phase__act\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Init
...
bool Vswitch___024root___eval_phase__nba(Vswitch___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vswitch__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vswitch___024root___eval_phase__nba\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Init
...
void Vswitch___024root___eval(Vswitch___024root* vlSelf) {
    ...
    while (__VicoContinue) {
        ...
        __VicoContinue = 0U;
        if (Vswitch___024root___eval_phase__ico(vlSelf)) {
            __VicoContinue = 1U;
        }
    ...
    while (__VnbaContinue) {
        ...
        while (vlSelfRef.__VactContinue) {
            ...
            if (Vswitch___024root___eval_phase__act(vlSelf)) {
                vlSelfRef.__VactContinue = 1U;
            }
        }
        if (Vswitch___024root___eval_phase__nba(vlSelf)) {
            __VnbaContinue = 1U;
        }
    }
}
